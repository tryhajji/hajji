...
const AgencyRegister = () => {
  ...
  const specialtyOptions = [
    'Hajj Packages', 'Umrah Packages', 'Group Tours', 'VIP Services',
    'Family Packages', 'Budget Packages', 'Educational Tours', 'Senior Care',
    'Disabled Access', 'Medical Tourism'
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Please provide detailed information about your travel agency
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-2xl">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Description Section */}
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Agency Description</h3>
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Provide a detailed description of your agency, including your experience, services, and what makes your agency unique..."
                />
              </div>
            </div>
